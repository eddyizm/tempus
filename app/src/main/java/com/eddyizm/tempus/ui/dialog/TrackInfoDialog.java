...
import com.eddyizm.tempus.databinding.DialogTrackInfoBinding;
...
public class TrackInfoDialog extends DialogFragment {
    ...
    private void bindAssetLink(android.view.View view, AssetLinkUtil.AssetLink assetLink) {
        ...
        view.setOnClickListener(v -> {
            ...
            ((com.eddyizm.tempus.ui.activity.MainActivity) requireActivity()).openAssetLink(assetLink, collapse);
        });
