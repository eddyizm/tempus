...
import com.eddyizm.tempus.databinding.ItemHorizontalArtistBinding;
...
public class ArtistHorizontalAdapter extends RecyclerView.Adapter<ArtistHorizontalAdapter.ViewHolder> implements Filterable {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void onClick() {
            ...
            bundle.putParcelable(Constants.ARTIST_OBJECT, artists.get(getBindingAdapterPosition()).strippedForNav());
